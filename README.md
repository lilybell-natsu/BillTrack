...
1. GitHubで新しいリポジトリを作成する(例: `money-docs-tracker`)
2. このフォルダの中身一式をリポジトリにpushする
   ...
   git branch -M main
   git remote add origin https://github.com/<あなたのユーザー名>/money-docs-tracker.git
...
5. 数分後に `https://<あなたのユーザー名>.github.io/money-docs-tracker/` で公開されます
